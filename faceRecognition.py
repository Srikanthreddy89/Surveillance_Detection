...
def faceDetection(test_img):             
    ...
    faces=face_haar.detectMultiScale(gray_img,scaleFactor=1.1,minNeighbors=5)
...
def draw_rect(test_img,face):                                      
    (x,y,w,h)=face
    cv2.rectangle(test_img,(x,y),(x+w,y+h),(55, 20, 255),thickness=2)

#Putting text on images
def put_text(test_img,text,x,y):                                    
    cv2.putText(test_img,text,(x,y),cv2.FONT_HERSHEY_COMPLEX,3,(20, 255, 59),6)
